...
📦 petcare-landing-page
 ...
 ┣ 📜 app.js             # Lógica JS (validação, agendamento, painel)
...
- [Ver perfil profissional no LinkedIn](https://www.linkedin.com/in/danielcanaud-dev/)
- [Ver mais projetos no GitHub](https://github.com/DanielCanaud)
...
3. Veja o agendamento listado em `agenda.html`
4. Teste filtros, busca e botão de limpar histórico
